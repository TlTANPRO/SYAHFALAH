  ...
  return (
    <header className="sticky top-0 z-30 h-16 border-b border-[var(--color-border-subtle)] bg-[var(--color-surface-0)]/80 backdrop-blur-md overflow-x-hidden">
      <div className="flex h-full items-center gap-3 px-4 min-w-0">
        ...
        {/* Path */}
        <div className="hidden md:flex items-center gap-1.5 text-sm shrink-0" aria-label="Current path">
        ...
        <form onSubmit={handleSearch} className="hidden sm:flex flex-1 min-w-0 ml-2 md:ml-6">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full h-9 pl-10 pr-20 rounded-md bg-[var(--color-surface-1)] border border-[var(--color-border-subtle)] text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:border-[var(--color-brand-500)] focus:ring-1 focus:ring-[var(--color-brand-500)]/30 transition-all"
        ...
        <div className="flex items-center gap-1 ml-1">
          ...
          {/* User Menu — z-50 so dropdown floats above everything */}
