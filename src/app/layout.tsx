      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('syahfalah-theme');var c=document.documentElement.classList;if(t==='light'){c.remove('dark');}else{c.add('dark');}}catch(e){}})();`,
          }}
        />
      </head>
      <noscript>
