// app/(dashboard)/admin/divisions/loading.tsx
// Loading skeleton for division admin — 2 parallel queries
// (divisions + division_task_summary view).

export default function Loading() {
  return (
    <div className="space-y-6 animate-pulse" aria-busy="true" aria-label="Memuat divisi">
      <div>
        ...
        {[...Array(6)].map((_, i) => (
          <div key={i} className="card">
            <div className="card-body p-4 space-y-3">
              ...
              <div className="flex gap-2 pt-2 border-t border-[var(--color-border-default)]/50">
