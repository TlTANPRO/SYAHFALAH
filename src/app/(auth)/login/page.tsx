...
function LoginForm() {
  ...
  // Demo accounts are ONLY rendered when NEXT_PUBLIC_SHOW_DEMO_ACCOUNTS=true.
  // Production deploys must keep this flag OFF to avoid leaking PINs in client bundle.
