    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-surface-0)] p-4">
      <Card className="max-w-lg w-full shadow-xl">
        <CardContent className="pt-12 pb-10 px-8 text-center">
          <div className="inline-flex items-center justify-center h-20 w-20 rounded-2xl bg-[var(--color-danger)]/10 mb-6">
            <AlertTriangle className="h-12 w-12 text-[var(--color-danger)]" />
          </div>
          <h1 className="font-heading text-2xl font-bold tracking-tight mb-3">
            Terjadi Kesalahan
          </h1>
          <p className="text-[var(--color-text-secondary)] text-sm mb-2 max-w-sm mx-auto">
            Dashboard gagal memuat. Coba muat ulang, atau kembali ke beranda.
          </p>
          {error.digest && (
            <p className="text-xs text-[var(--color-text-secondary)]/60 mb-6 font-mono">
              ref: {error.digest}
            </p>
          )}
